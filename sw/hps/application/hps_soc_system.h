 ...
 * file 'DE1_SoC_demo/hw/quartus/soc_system.sopcinfo'.
 */
...
/*
 * Macros for device 'hps_adaptive_threshold_dma', class 'adaptive_threshold'
 * The macros are prefixed with 'HPS_ADAPTIVE_THRESHOLD_DMA_'.
 * The prefix is the slave descriptor.
 */
#define HPS_ADAPTIVE_THRESHOLD_DMA_COMPONENT_TYPE adaptive_threshold
#define HPS_ADAPTIVE_THRESHOLD_DMA_COMPONENT_NAME hps_adaptive_threshold_dma
#define HPS_ADAPTIVE_THRESHOLD_DMA_BASE 0x10
#define HPS_ADAPTIVE_THRESHOLD_DMA_SPAN 16
#define HPS_ADAPTIVE_THRESHOLD_DMA_END 0x1f
